...
{
    public class SiGLRequiresRoleInterceptor : OperationInterceptor
    {

        #region Constructors

        public SiGLRequiresRoleInterceptor(ICommunicationContext context)
        {
            _context = context;
        }
